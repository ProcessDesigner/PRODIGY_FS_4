...
import {
  ...
  const register = (userData) => async (dispatch) => {
    try {
      ...
      const { data } = await axiosInstance.post(`/user/register`, userData, config);
  ...
  // Update Profile
   const updateProfile = (userData) => async (dispatch) => {
    try {
      ...
      const { data } = await axiosInstance.put(`/user/me/update`, userData, config);
  ...
  // Forgot Password
   const forgotPassword = (email) => async (dispatch) => {
    try {
      ...
      const { data } = await axiosInstance.post(`/user/password/forgot`, email, config);
  ...
  const getUserDetails = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axiosInstance.get(`/user/admin/user/${id}`);
  ...
  const deleteUser = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axiosInstance.delete(`/user/admin/user/${id}`);
